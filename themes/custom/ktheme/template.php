<?php
function ktheme_preprocess_page(&$variables) {
...
function ktheme_breadcrumb(&$variables) {
  $output = '';
...
function ktheme_feed_icon(&$variables) {
...
function ktheme_preprocess_html(&$variables) {
  ...
  elseif (theme_get_setting('path_background')) {
    $bg = variable_get('ktheme:path_background', '');
