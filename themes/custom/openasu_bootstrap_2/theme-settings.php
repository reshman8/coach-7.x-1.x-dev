 ...
 */
function openasu_bootstrap_tci_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['theme_configuration']['default_picture'] = array(
    ...
    '#default_value' => theme_get_setting('default_picture', 'openasu_bootstrap_tci'),
    '#tree' => FALSE,
  ...
  $form['theme_configuration']['settings']['picture_path'] = array(
    ...
    '#default_value' => theme_get_setting('picture_path', 'openasu_bootstrap_tci'),
  );
  ...
  $form['#submit'][] = 'openasu_bootstrap_tci_settings_submit';
  $form['#validate'][] = 'openasu_bootstrap_tci_settings_validate';
}

function openasu_bootstrap_tci_settings_submit($form, &$form_state) {
...
function openasu_bootstrap_tci_settings_validate($form, &$form_state) {
  // Handle file uploads.
