$ drush make https://raw.github.com/maustyle/coach-7.x-1.x-dev/dev1/stub.make coach-7.22-dev1.90/
...
admin_menu-7.x-3.0-rc4 downloaded. >>>> Project views_bulk_operations contains 2 modules: actions_permissions, views_bulk_operations.
...
backports-7.x-1.0-alpha1 downloaded. DRUSH_BACKEND:{"type":"command","message":"Backend invoke: \/usr\/local\/bin\/php \/usr\/local\/Cellar\/drush\/5.8\/libexec\/drush.php --php=\/usr\/local\/bin\/php--backend=2 --reserve-margin=4make-process \/tmp\/make_tmp_1375053635_51f5a743298d6 2>&1","timestamp":1375053667.405,"memory":13652624,"error":null,"packet":"log"}dhtml_menu-7.x-1.0-beta1 downloaded. 
...
coffee-7.x-2.0 downloaded. >> Install location /private/tmp/make_tmp_1375053635_51f5a743298d6/__build__/profiles/mm/modules/contrib/admin_menu already exists. Do you want to overwrite it? (y/n): y >> Project admin_menu contains 3 modules: admin_menu_toolbar, admin_devel, admin_menu.
...
libraries-7.x-2.1 downloaded. >>>> Project entity contains 2 modules: entity, entity_token.
...
media patched with media-browser-enter-submit-frontpage-1319528-11.patch. Generated PATCHES.txt file for media >>>> Project admin_menu contains 3 modules: admin_menu_toolbar, admin_devel, admin_menu.
...
panopoly_core-7.x-1.0-rc4 downloaded. Found makefile: panopoly_core.make >>>> Project menu_block contains 2 modules: menu_block, menu_block_export.
...
panopoly_pages-7.x-1.0-rc4 downloaded. >>>> Project search_api contains 3 modules: search_api_views, search_api_facetapi, search_api. >>>> Project facetapi contains 2 modules: current_search, facetapi.
...
pathauto patched with 936222-pathauto-persist.patch. Generated PATCHES.txt file for pathauto >> Install location /private/tmp/make_tmp_1375053635_51f5a743298d6/__build__/profiles/mm/modules/contrib/devel already exists. Do you want to overwrite it? (y/n): >> y >> Project devel contains 3 modules: devel_generate, devel, devel_node_access.

pathauto-7.x-1.2 downloaded. 

pm_existing_pages-7.x-1.4 downloaded.
...
search_api_solr patched with 1407282-variable_solr_connection_class-37.patch. Generated PATCHES.txt file for search_api_solr 
...
views_autocomplete_filters-7.x-1.0-beta2 downloaded. >>>> Project views contains 2 modules: views, views_ui.
