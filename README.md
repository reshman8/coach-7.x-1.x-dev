--------------------------------------------------------------------------------------------------------------------------------------------------- 20:55:26
Aphrodite@rl:~/Sites$ drush make ~/Documents/WORKZ/TCI/main/repos/tci-7-x-v2-3-dev1/stub.make tci-7.x-2.3-dev18/
...
Generated PATCHES.txt file for defaultcontent                                                                                                    [ok]
 >> Install location /private/tmp/make_tmp_1374405210_51ebc25ab7758/__build__/profiles/mm/modules/contrib/devel already exists. Do you want to overwrite it? (y/n):
 >> y
 >> Project devel contains 3 modules: devel_generate, devel, devel_node_access.
coffee-7.x-2.0 downloaded.                                                                                                                       [ok]
devel-7.x-1.3 downloaded.                                                                                                                        [ok]
 >> Install location /private/tmp/make_tmp_1374405210_51ebc25ab7758/__build__/profiles/mm/modules/contrib/admin_menu already exists. Do you want to overwrite it? (y/n):
 >> y
 >> Project admin_menu contains 3 modules: admin_menu_toolbar, admin_devel, admin_menu.
...
>>  >> Project entityreference contains 2 modules: entityreference_behavior_example, entityreference.entityreference-7.x-1.0 downloaded.                                                                                                              [ok]
 >> >> Install location /private/tmp/make_tmp_1374405210_51ebc25ab7758/__build__/profiles/mm/modules/contrib/libraries already exists. Do you want to overwrite it? (y/n): y
...
>>  >> Project views_bulk_operations contains 2 modules: actions_permissions, views_bulk_operations.pathauto patched with 936222-pathauto-persist.patch.                                                                                             [ok]
