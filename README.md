...
$ drush make https://raw.github.com/maustyle/coach-7.x-1.x-dev/dev1/stub.make coach-7.18-dev1.93/
...
context-7.x-3.0-beta6 downloaded.>>>> Project entityreference contains 2 modules: entityreference_behavior_example, entityreference.
...
dhtml_menu-7.x-1.0-beta1 downloaded.>> DRUSH_BACKEND:{"type":"notice","message":" >> \/usr\/local\/bin\/php \/usr\/ >> ocal\/Cellar\/drush\/5.8\/libexec\/drush.php --php=\/usr\/local\/bin\/php--backend=2 --reserve-margin=4make-process \/tmp\/make_tmp_1375056965_51f5b4454ea8c 2>&1","timestamp":1375056999.8604,"memory":13670584,"error":null,"packet":"log"}nice_menus-7.x-2.5 downloaded. 

diff-7.x-3.2 downloaded. >> Install location /private/tmp/make_tmp_1375056965_51f5b4454ea8c/__build__/profiles/mm/modules/contrib/devel already exists. Do you want to overwrite it? (y/n) >>>> Project devel contains 3 modules: devel_generate, devel, devel_node_access >>>> Project entity contains 2 modules: entity, entity_token.
...
file_entity cloned from http://git.drupal.org/project/file_entity.git. Checked out revision c2d5c3d.Checked out revision ecb9392.
...
markitup patched with 1715642-adding-html-set-markitup-editor.patch. DRUSH_BACKEND:{"type":"ok","message":"Generated PATCHES.txt file for markitup","timestamp":1375056988.5329,"memory":13342864,"error":null,"packet":"log"} >>>> Project admin_menu contains 3 modules: admin_menu_toolbar, admin_devel, admin_menu.
...
menu_firstchild-7.x-1.1 downloaded.
...
pathauto patched with 936222-pathauto-persist.patch. Generated PATCHES.txt file for pathauto>> Install location /private/tmp/make_tmp_1375056965_51f5b4454ea8c/__build__/profiles/mm/modules/contrib/admin_menu already exists. Do you want to overwrite it? (y/n):>> Project admin_menu contains 3 modules: admin_menu_toolbar, admin_devel, admin_menu.
...
search_api_solr patched with 1407282-variable_solr_connection_class-37.patch.Generated PATCHES.txt file for search_api_solr >>>> Project search_api contains 3 modules: search_api_views, search_api_facetapi, search_api >>>> Project facetapi contains 2 modules: current_search, facetapi.

search_api_solr-7.x-1.0-rc3 downloaded.

simple_gmap-7.x-1.0 downloaded.

simplehtmldom-7.x-1.12 downloaded. >> Project nodehierarchy contains 3 modules: nodehierarchy_widgets, nodehierarchy_views, nodehierarchy.strongarm-7.x-2.0 downloaded.
...
superfish downloaded from https://github.com/mehrpadin/Superfish-for-Drupal/zipball/master.>> >> Project devel contains 3 modules: devel_generate, devel, devel_node_access.
...
token-7.x-1.5 downloaded.>> >> Project views_bulk_operations contains 2 modules: actions_permissions, views_bulk_operations.

uuid cloned from http://git.drupal.org/project/uuid.git. Checked out revision 4730c67.

uuid patched with 1605284-define-types-for-tokens-6.patch. Generated PATCHES.txt file for uuid>> Project menu_editor contains 3 modules: me_path_autocomplete, me_node_creation, menu_editor.
